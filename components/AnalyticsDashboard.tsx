...
const Badge = ({ percentage }: { percentage: number }) => {
  ...
  return (
    <span
      className={`inline-flex gap-1 items-center rounded-md px-2 py-1
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="grid w-full mx-auto grid-cols-1 sm:grid-cols-2 gap-6">
        ...
        <Card className="w-full mx-auto max-w-xs">
          <p className="flex gap-2 items-center text-tremor-default text-dark-tremor-content">
            Visitors Today
            <Badge
              percentage={
      ...
      <Card className="flex flex-col sm:grid grid-cols-4 gap-6">
        <h2 className="w-full text-dark-tremor-content text-center sm:left-left font-semibold text-xl">
          ...
          {topCountries.map(([countryCode, number]) => {
            return (
              ...
              >
                ...
                />
                <p className="text-tremor-content-strong sm:text-tremor-content">
                  {number}
                </p>
              </div>
            );
